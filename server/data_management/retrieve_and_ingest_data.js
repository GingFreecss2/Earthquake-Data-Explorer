// necessary dependencies to receive and send http requests
const express = require('express');
const router = express.Router();
const axios = require('axios');

//require elasticsearch client and log-timestamp dependency
const client = require('../elasticsearch/client');
require('log-timestamp');

//Url of the api to retreive earthquake data for the last 30 days
// usgs = United States Geological Survey
const URL = `https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_month.geojson`;

//define /earthquakes route 
